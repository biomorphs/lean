...
function MakeIsland()
	...
	m:SetFloat("GrassMinHeight",2)
	m:SetFloat("GrassAngleMin",0.9)
	m:SetFloat("GrassAngleMul",5)
	m:SetFloat("BeachHeight",1.1)
	m:SetFloat("BeachThickness",1.5)
	...
	sdfModel:SetBounds(vec3.new(0,0,0),vec3.new(IslandSDFSize[1],IslandSDFSize[2],IslandSDFSize[3]))
